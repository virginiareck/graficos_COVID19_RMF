# -*- coding: utf-8 -*-
"""Cópia de 10_Graficos_linha_barras

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_8AV2jrW27sk2_TV9Z-pukGfQXz02_sg
...
"""#agrupa por cidade e semana epidemiológica"""

mediaMovel_maiores_agrupado_2020 = maiores_cidades_2020.groupby(['city','epidemiological_week',])['new_confirmed','new_deaths','date'].mean().reset_index()
mediaMovel_maiores_agrupado_2020

mediaMovel_maiores_agrupado_2021 = maiores_cidades_2021.groupby(['city','epidemiological_week',])['new_confirmed','new_deaths'].mean().reset_index()
mediaMovel_maiores_agrupado_2021

mediaMovel_maiores_agrupado_2022 = maiores_cidades_2022.groupby(['city','epidemiological_week',])['new_confirmed','new_deaths'].mean().reset_index()
mediaMovel_maiores_agrupado_2022

fig = px.line(mediaMovel_maiores_agrupado_2020, x="epidemiological_week", y="new_confirmed", color="city")
fig.update_layout(
    title="mediaMovel_maiores_agrupado_2020",
...
def plot_mediamovel(timeseries):
  ...
  mean = plt.plot(rolmean, color = 'red', label='Média móvel 7 dias')
  plt.legend(loc='best')
  plt.title('Valor original e média móvel dos 7 dias')
...
for city, date in df_cidades_maiores.groupby('city'):
    plt.plot(date['date'], date['new_confirmed'],label=city)
plt.tight_layout()
plt.title('Novos casos nas 4 maiores cidades da RMF', fontsize=28,fontweight='bold')
...
from IPython.core.pylabtools import figsize
plt.figure(figsize=(25,15))
for city, date in cidades_SC.groupby('city'):
    plt.plot(date['date'], date['new_confirmed'],label=city)
plt.tight_layout()
plt.title('Novos casos nas 9 cidades da RMF', fontsize=32,fontweight='bold')
plt.xlabel('Data',fontsize=28,fontweight='bold')
plt.ylabel('Novos casos',fontsize=28,fontweight='bold')
plt.tick_params(labelsize=24)

plt.legend(fontsize=24, frameon=True, framealpha=0.5, facecolor='white')
plt.show()
...
for city, date in maiores_cidades_2021.groupby('city'):
    plt.plot(date['date'], date['new_confirmed'],label=city)
plt.tight_layout()
plt.title('Novos casos nas 4 maiores cidades da RMF no ano 2021 e início de 2022', fontsize=32,fontweight='bold')
plt.xlabel('Data',fontsize=28,fontweight='bold')
plt.ylabel('Novos casos',fontsize=28,fontweight='bold')
plt.tick_params(labelsize=24)
...
for city, date in maiores_cidades_2022.groupby('city'):
    plt.plot(date['date'], date['new_confirmed'],label=city)
plt.tight_layout()
plt.title('Novos casos nas 4 maiores cidades da RMF no ano 2022', fontsize=32,fontweight='bold')
plt.xlabel('Data',fontsize=28,fontweight='bold')
plt.ylabel('Novos casos',fontsize=28,fontweight='bold')
plt.tick_params(labelsize=24)
